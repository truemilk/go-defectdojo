...
func (c *Client) ProductsList(ctx context.Context, options *ProductsOptions) (*Products, error) {
	path := fmt.Sprintf("%s/products/%s", c.BaseURL, options.ToString())
...
func (c *Client) ProductsRead(ctx context.Context, id int) (*Product, error) {
	path := fmt.Sprintf("%s/products/%d/", c.BaseURL, id)
...
func (c *Client) ProductsCreate(ctx context.Context, u *Product) (*Product, error) {
	path := fmt.Sprintf("%s/products/", c.BaseURL)
...
func (c *Client) ProductsDelete(ctx context.Context, id int) (*Product, error) {
	path := fmt.Sprintf("%s/products/%d/", c.BaseURL, id)
